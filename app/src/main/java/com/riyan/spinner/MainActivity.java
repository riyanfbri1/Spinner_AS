...
public class MainActivity extends AppCompatActivity {
    ...
    private void initSpinner4(){
        List<String> genaplList = new ArrayList<>();

        for (int i=2; i<=1000; i+=2){
            genaplList.add("Bilangan ke-" +i);
        }
        ArrayAdapter<String> arrayAdapter4 = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1,genaplList);
